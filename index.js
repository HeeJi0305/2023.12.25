...
let modalMessageList = [
  ...
  { "number": 23, "message": "<2023.12.23 참 부끄럽고 민망한 날> 어제 세인이랑 살짝 다투고 그냥 여러모로 부끄러운 날이었다. 오늘 아침에 캘린더를 확인해보니 아침엔 왠걸! 어드벤트 캘린더도 잘못 해부렀네..!? 어떻게 지금 수습하고 있는 중인데.. 솔직히 세인이가 나한테 실망했을 것 같아서 무서웠다. 아니 사실 실망하는게 당연해보일 수 있지만.. 뭔가 더 말을 붙이기엔 찌잘해보이고.. 더 말을 하기엔 변명같고.. 여러모로 미안하고.. 울컥하고.. 속상한 날이었다. 내가 왜 그랬지 싶다가도 그치만 앞으로가 중요한 거니까 내가 잘 할게... 반성 즁..." },
  { "number": 24, "message": "세인아 25일까지 하루 남았는데, 어드벤트 캘린터 재밌었는지 모르겠어. 나는 만들면서 재밌었구 세인이랑 추억을 돌아볼 수 있어서 좋았어. 세인이도 즐거웠으면 좋겠다." },
  { "number": 24, "message": "12월 25일!!! 메리 크리스마스!!! 세인아, 올해 어땠어? 괜찮았어? 나는 올해 꽤 많은 일들이 있었는데 그 중 제일 잘한 일, 좋은 일, 감사한 일 등등 모든 긍정적인 일 중 가장 잘한 일은 세인이를 만난 일이라고 생각해. 아무리 표현해도 모자라고 했던 말 또하고 또하고 해서 지겨워진다고 해도.. 내 마음을 표현하기 모자란 것 같아. 정말 많이 고맙고 많이 사랑해 마니 마니 진짜루 사랑해애.. 내년에도 우리 같이 있쟈 메리 크리스마스" }
]
  ;
